...
class _MachineSelectionTabState extends State<MachineSelectionTab> {
  final TextEditingController _typeAheadManufacturerController = TextEditingController();
  final TextEditingController _typeAheadModelController = TextEditingController();
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          TypeAheadFormField(
            ...
            suggestionsCallback: (pattern) async {
              return MachineService.getModellSuggestions(pattern, _selectedManufacturer);
            },
            itemBuilder: (context, suggestion) {
              return ListTile(
                title: Text(suggestion),
